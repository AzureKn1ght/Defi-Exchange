...
export const getAmountOfTokensReceivedFromSwap = async (
  ...
  // `_swapAmountWei` ETH, the input reserve would be the `ethBalance` of the contract and output reserve
  ...
  if (ethSelected) {
    ...
    // `_swapAmountWei` CD, the input reserve would be the `Crypto Dev` token reserve of the contract and output reserve
